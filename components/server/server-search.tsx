...
const ServerSearch = ({
  ...
  const onClick: any = ({ id, type }: { id: string, type: "channel" | "member" }) => {
    setOpen(false);
  ...
  return (
    <>
      <button
        ...
        className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-70/50 transition"
      >
